...
@RestController
@RequestMapping(value = "sys/buttomRegister")
public class ButtomRegisterController {
	...
	public Object buttomRegisterListApi(@RequestParam(value = "moudelName") String moudelName, @RequestParam(value = "moudelId") String moudelId,
	...
	public void buttomRegisterDelApi(@RequestParam(value = "moudleId") String moudleId) throws ThinventBaseException {
	...
	@ApiOperation(value = "模块--模块查询", notes = "查询所有模块列表")
	@ApiImplicitParam(name = "moudleId", required = true, value = "当前页")
	public String buttomRegisterOneApi(@RequestParam(value = "moudleId") String moudleId) throws ThinventBaseException {
	...
	public Map<String, String> buttomRegisterUpdateApi(@RequestBody MoudleVO moudleVO) throws ThinventBaseException {
	...
	@ApiImplicitParam(name = "moudleVO", required = true, value = "模块", dataType = "MoudleVO")
	public Map<String, String> buttomRegisterAddApi(@RequestBody MoudleVO moudleVO) throws ThinventBaseException {
